...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : undefined || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var a = Math.PI / 180,
    ...
    var d,
        ...
        l = s(a, b, 0, j, k),
        o = 0;for (f = 6; g > f; f += 6) {
      e = s(a, b, f / 6, j, k), l > e && (l = e, o = f);
    }if (c) for (d = a.slice(0), m(d), f = 6; g > f; f += 6) {
      e = s(d, b, f / 6, j, k), l > e && (l = e, o = -f);
    }return o / 6;
  },
      u = function u(a, b, c) {
    ...
    var e,
        ...
        m = a.size || o(a),
        n = a.centerX,
        p = a.centerY;for (e = c; i > e && (m = b[e].size || o(b[e]), !(k > m)); e++) {
      f = b[e].centerX - n, g = b[e].centerY - p, h = Math.sqrt(f * f + g * g), l > h && (j = e, l = h);
    }return h = b[j], b.splice(j, 1), h;
  },
    ...
    var e,
        ...
        o = 0,
        s = "complexity" === d ? p : q,
        w = "position" === d ? 0 : "number" == typeof d ? d : .8,
        x = n.length,
        y = "object" == (typeof c === "undefined" ? "undefined" : _typeof(c)) && c.push ? c.slice(0) : [c],
        z = "reverse" === y[0] || y[0] < 0;if (n[0]) {
      if (l.length > 1 && (a.sort(s), b.sort(s), s === q)) for (x = 0; x < n.length; x++) {
        l.splice(x, 0, v(n[x], l, x, w));
      }if (j) for (0 > j && (j = -j), l[0].length > n[0].length && k(n[0], (l[0].length - n[0].length) / 6 | 0), x = n.length; j > o;) {
        g = u(n, l[x][0], l[x][1]), h = g[0], i = g[1], n[x++] = [h, i, h, i, h, i, h, i], n.totalPoints += 8, o++;
      }for (x = 0; x < a.length; x++) {
        e = b[x], f = a[x], j = e.length - f.length, 0 > j ? k(e, -j / 6 | 0) : j > 0 && k(f, j / 6 | 0), z && !f.reversed && m(f), c = y[x] || 0 === y[x] ? y[x] : "auto", c && (f.closed || Math.abs(f[0] - f[f.length - 2]) < .5 && Math.abs(f[1] - f[f.length - 1]) < .5 ? "auto" === c ? (y[x] = c = t(f, e, 0 === x), 0 > c && (z = !0, m(f), c = -c), r(f, 6 * c)) : "reverse" !== c && (x && 0 > c && m(f), r(f, 6 * (0 > c ? -c : c))) : !z && ("auto" === c && Math.abs(e[0] - f[0]) + Math.abs(e[1] - f[1]) + Math.abs(e[e.length - 2] - f[f.length - 2]) + Math.abs(e[e.length - 1] - f[f.length - 1]) > Math.abs(e[0] - f[f.length - 2]) + Math.abs(e[1] - f[f.length - 1]) + Math.abs(e[e.length - 2] - f[0]) + Math.abs(e[e.length - 1] - f[1]) || c % 2) ? (m(f), y[x] = -1, z = !0) : "auto" === c ? y[x] = 0 : "reverse" === c && (y[x] = -1));
      }return y;
    }
  },
      x = function x(a, b, c) {
    var d = j(a[0]),
        e = j(a[1]);w(d, e, b || 0 === b ? b : "auto", c) && (a[0] = l(d), a[1] = l(e));
  },
      y = function y(a, b) {
    ...
    var b = a[0].match(d) || [],
        c = a[1].match(d) || [],
        e = c.length - b.length;e > 0 ? a[0] = A(b, e) : a[1] = A(c, -e);
  },
      C = function C(a) {
    ...
    var c,
        ...
        z = .552284749831;return "path" !== y && a.getBBox ? (i = D(a, "x,y,width,height,cx,cy,rx,ry,r,x1,x2,y1,y2,points"), "rect" === y ? (g = +a.getAttribute("rx") || 0, h = +a.getAttribute("ry") || 0, e = +a.getAttribute("x") || 0, f = +a.getAttribute("y") || 0, m = (+a.getAttribute("width") || 0) - 2 * g, n = (+a.getAttribute("height") || 0) - 2 * h, g || h ? (o = e + g * (1 - z), p = e + g, q = p + m, r = q + g * z, s = q + g, t = f + h * (1 - z), u = f + h, v = u + n, w = v + h * z, x = v + h, c = "M" + s + "," + u + " V" + v + " C" + [s, w, r, x, q, x, q - (q - p) / 3, x, p + (q - p) / 3, x, p, x, o, x, e, w, e, v, e, v - (v - u) / 3, e, u + (v - u) / 3, e, u, e, t, o, f, p, f, p + (q - p) / 3, f, q - (q - p) / 3, f, q, f, r, f, s, t, s, u].join(",") + "z") : c = "M" + (e + m) + "," + f + " v" + n + " h" + -m + " v" + -n + " h" + m + "z") : "circle" === y || "ellipse" === y ? ("circle" === y ? (g = h = +a.getAttribute("r") || 0, k = g * z) : (g = +a.getAttribute("rx") || 0, h = +a.getAttribute("ry") || 0, k = h * z), e = +a.getAttribute("cx") || 0, f = +a.getAttribute("cy") || 0, j = g * z, c = "M" + (e + g) + "," + f + " C" + [e + g, f + k, e + j, f + h, e, f + h, e - j, f + h, e - g, f + k, e - g, f, e - g, f - k, e - j, f - h, e, f - h, e + j, f - h, e + g, f - k, e + g, f].join(",") + "z") : "line" === y ? c = "M" + a.getAttribute("x1") + "," + a.getAttribute("y1") + " L" + a.getAttribute("x2") + "," + a.getAttribute("y2") : ("polyline" === y || "polygon" === y) && (l = (a.getAttribute("points") + "").match(d) || [], e = l.shift(), f = l.shift(), c = "M" + e + "," + f + " L" + l.join(","), "polygon" === y && (c += "," + e + "," + f + "z")), i.setAttribute("d", c), b && a.parentNode && (a.parentNode.insertBefore(i, a), a.parentNode.removeChild(a)), i) : a;
  },
      F = function F(a, b, c) {
    var e, h;return ("string" != typeof a || (a.match(d) || []).length < 3) && (e = f.selector(a), e && e[0] ? (e = e[0], h = e.nodeName.toUpperCase(), b && "PATH" !== h && (e = E(e, !1), h = "PATH"), a = e.getAttribute("PATH" === h ? "d" : "points") || "", e === c && (a = e.getAttributeNS(null, "data-original") || a)) : (g("WARNING: invalid morph to: " + a), a = !1)), a;
  },
      G = "Use MorphSVGPlugin.convertToPath(elementOrSelectorText) to convert to a path before morphing.",
      H = _gsScope._gsDefine.plugin({ propName: "morphSVG", API: 2, global: !0, version: "0.6.0", init: function init(a, b, c) {
      var d, f, h, i, j;return "function" != typeof a.setAttribute ? !1 : (d = a.nodeName.toUpperCase(), j = "POLYLINE" === d || "POLYGON" === d, "PATH" === d || j ? (f = "PATH" === d ? "d" : "points", ("string" == typeof b || b.getBBox || b[0]) && (b = { shape: b }), i = F(b.shape || b.d || b.points || "", "d" === f, a), j && e.test(i) ? (g("WARNING: a <" + d + "> cannot accept path data. " + G), !1) : (i && (this._target = a, a.getAttributeNS(null, "data-original") || a.setAttributeNS(null, "data-original", a.getAttribute(f)), h = this._addTween(a, "setAttribute", a.getAttribute(f) + "", i + "", "morphSVG", !1, f, "d" === f ? y(b.shapeIndex, b.map) : C(b.shapeIndex)), h && (this._overwriteProps.push("morphSVG"), h.end = i, h.endProp = f)), !0)) : (g("WARNING: cannot morph a <" + d + "> SVG element. " + G), !1));
    }, set: function set(a) {
    ...
    var c,
        ...
        g,
        h,
        i = j(F(a, !0))[0] || [];if (b = b || {}, f = b.matrix, c = [], e = i.length, f) for (b.relative && (f = f.slice(0), f[4] -= i[0], f[5] -= i[1]), d = 0; e > d; d += 2) {
      c.push({ x: i[d] * f[0] + i[d + 1] * f[2] + f[4], y: i[d] * f[1] + i[d + 1] * f[3] + f[5] });
    } else for (g = b.offsetX || 0, h = b.offsetY || 0, b.relative && (g -= i[0], h -= i[1]), d = 0; e > d; d += 2) {
      c.push({ x: i[d] + g, y: i[d + 1] + h });
    }return c;
  };
